      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            <p className="text-tzipur-muted mb-6">
            ...
            <div className="w-full flex flex-col gap-3">
              <button
                onClick={onConfirm}
                className="w-full bg-red-500 text-white py-3 rounded-2xl font-medium shadow-sm hover:bg-red-600 transition-colors active:scale-[0.98]"
              >
